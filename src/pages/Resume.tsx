      ...
      <div className="container mx-auto px-4">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-12">
            <div>
              <h1 className="text-4xl font-bold text-blue-deep mb-4">My Resume</h1>
          ...
          <section className="mb-16 animate-fade-in">
            <div className="flex items-center mb-6">
              <Code className="text-blue-deep mr-3" size={24} />
              <h2 className="text-2xl font-bold text-blue-deep">Technical Skills</h2>
            </div>
          ...
          <section className="mb-16 animate-fade-in" style={{ animationDelay: "100ms" }}>
            <div className="flex items-center mb-8">
              <Briefcase className="text-blue-deep mr-3" size={24} />
              <h2 className="text-2xl font-bold text-blue-deep">Work Experience</h2>
            </div>
            <div className="space-y-8">
              {experiences.map((exp, index) => (
                <div key={index} className="relative pl-8 border-l-2 border-gray-200 pb-8 last:pb-0">
                  <div className="absolute -left-[9px] top-0 w-4 h-4 rounded-full bg-teal-custom"></div>
                  <h3 className="text-xl font-semibold text-blue-deep">{exp.title}</h3>
          ...
          <section className="animate-fade-in" style={{ animationDelay: "200ms" }}>
            <div className="flex items-center mb-8">
              <GraduationCap className="text-blue-deep mr-3" size={24} />
              <h2 className="text-2xl font-bold text-blue-deep">Education</h2>
            </div>
            <div className="space-y-8">
              {education.map((edu, index) => (
                <div key={index} className="relative pl-8 border-l-2 border-gray-200 pb-8 last:pb-0">
                  <div className="absolute -left-[9px] top-0 w-4 h-4 rounded-full bg-blue-deep"></div>
                  <h3 className="text-xl font-semibold text-blue-deep">{edu.degree}</h3>
                  <div className="flex items-center text-gray-600 mb-2">
